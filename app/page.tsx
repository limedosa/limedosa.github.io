          ...
          <div className="container px-0 md:px-6">
            <div className="grid md:grid-cols-12 gap-6 md:gap-8 items-center">
              <div className="md:col-span-4 flex flex-col items-center text-center">
                ...
                <p className="text-primary font-medium">AI Engineer @ Jefferies Group LLC</p>
            ...
            <div className="space-y-8 md:space-y-10 max-w-3xl mx-auto">
              <div className="border-l-2 border-primary pl-4 md:pl-6 relative">
                ...
                <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-1">
                  ...
                  <p className="text-muted-foreground text-xs sm:text-sm">Feb 2025 - Present</p>
                </div>
              ...
              <div className="border-l-2 border-primary pl-4 md:pl-6 relative">
                ...
                <ul className="mt-2 space-y-1 list-disc list-inside text-xs md:text-sm">
                  <li>
                    Developed and optimized LSTM models to enhance ticker(stock) buy/sell signals, improving accuracy by
                    5%.
                  </li>
                  <li>
                  ...
                  <li>
                    Automated data collection from various APIs and performed feature extraction for thematic analysis,
                    informing targeted outreach strategies and improving CRM automation.
                  </li>
                  <li>Used MongoDB database for storing historical data and conducting analytics on large datasets.</li>
                  <li>
          ...
          <div className="container px-0 md:px-6">
            ...
            <div className="grid gap-4 sm:gap-6 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3">
              <ProjectCard
                ...
                githubLink="https://github.com/limedosa/prediction-bet"
              ...
              <ProjectCard
                title="AllChat"
                description="Designed and implemented a chat app with the ability to text users, like and comment on posts, as well as a feed. Supports image uploads."
                image="/placeholder.svg?height=400&width=600&text=Chat+Application"
                githubLink="https://github.com/designftw/hw11-limedosa/tree/master/hw12/chat%20app"
                demoLink="https://allchat.glitch.me"
                tags={["Vue.js", "JavaScript", "HTML/CSS", "UI/UX", "Figma"]}
              />
              <ProjectCard
