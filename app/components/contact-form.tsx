...
export default function ContactForm() {
  ...
  async function handleSubmit(event: React.FormEvent<HTMLFormElement>) {
    ...
    try {
      ...
      setMessage("Email client opened! If nothing happened, please email me directly.")
      setSuccess(true)
        ...
        <div className="flex flex-col items-center justify-center py-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <Link href="mailto:dlinda@mit.edu">
              <Button className="bg-gradient-to-r from-primary to-purple-500 hover:from-primary/90 hover:to-purple-500/90 transition-all duration-300 flex items-center gap-2">
